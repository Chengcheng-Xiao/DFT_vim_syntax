...
syntax match coordinatesMode "^\%>6l\%<10lC\w\+"
syntax match coordinatesMode "^\%>6l\%<10lD\w\+"
syntax match coordinatesMode "^\%>6l\%<10lS\w\+"


syntax match latticeConstant "\%2l.*$"

" back up latticeConstant regex
"^\%2l\d\+\.\?\d*$"
